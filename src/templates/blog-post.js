          ...
          <div className="flex_post">
            <div className="blog_left">
              ...
              <div className="sharing_icon">
                ...
                <a className="sharing" target="_blank">
                  <svg
                    width="30"
                    height="30"
                    viewBox="0 0 30 30"
